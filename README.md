...
- i18n para 26 línguas (PT na raiz + 23 línguas oficiais da UE, turco, norueguês e islandês em `/{lang}/`)
...
src/lib/
  ...
  content-translations.ts  # secções e itens de cada cartão nas 26 línguas
...
2. `src/lib/i18n.ts` → `entryTranslations` — título, subtítulo e descrição nas 26 línguas
3. `src/lib/content-translations.ts` — secções e itens nas 26 línguas
...
questão: as 24 línguas oficiais da UE mais o turco, o norueguês e o islandês. Cada cartão é escrito na língua dos
...
curso em Florença (Agosto 2026). A estrutura e os estilos já estão prontos nas 27 línguas.
