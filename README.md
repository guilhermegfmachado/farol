...
- i18n para 26 línguas (PT na raiz + 23 línguas oficiais da UE, turco e norueguês em `/{lang}/`)
...
src/lib/
  ...
  content-translations.ts  # secções e itens de cada cartão nas 25 línguas
...
2. `src/lib/i18n.ts` → `entryTranslations` — título, subtítulo e descrição nas 25 línguas
3. `src/lib/content-translations.ts` — secções e itens nas 25 línguas
...
questão: as 24 línguas oficiais da UE mais o turco e o norueguês. Cada cartão é escrito na língua dos
...
curso em Florença (Agosto 2026). A estrutura e os estilos já estão prontos nas 26 línguas.
