...
- i18n para 25 línguas (PT na raiz + 23 línguas oficiais da UE e turco em `/{lang}/`)
...
src/lib/
  ...
  content-translations.ts  # secções e itens de cada cartão nas 24 línguas
...
2. `src/lib/i18n.ts` → `entryTranslations` — título, subtítulo e descrição nas 24 línguas
...
questão: as 24 línguas oficiais da UE mais o turco. Cada cartão é escrito na língua dos
...
curso em Florença (Agosto 2026). A estrutura e os estilos já estão prontos nas 25 línguas.
